...
describe('endOfGame', () => {
    ...
    it('tests stalemate', () => expect(endOfGame('k7/7R/8/8/8/8/8/1R4K1 b - - 0 0')).toBe('draw'))
    it('tests fifty moves rule', () => expect(endOfGame('rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 100 50')).toBe('draw'))
